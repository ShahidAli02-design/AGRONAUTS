...
import { Route as MandiRoute } from "@/routes/mandi";
...
const routes: RouteDefinition[] = [
  ...
  { pattern: "/track", component: TrackRoute.component, head: TrackRoute.head },
  { pattern: "/history", component: HistoryRoute.component, head: HistoryRoute.head },
  { pattern: "/mandi", component: MandiRoute.component, head: MandiRoute.head },
  { pattern: "/track/$id", component: TrackRoute.component, head: TrackRoute.head },
