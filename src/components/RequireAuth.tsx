...
export function RequireAuth({ children, toolName, toolDescription }: RequireAuthProps) {
  ...
  if (user && role === "processor" && toolName !== "__allow_processor") {
    return (
      <AppShell signedIn>
        <div className="mx-auto max-w-xl py-10 px-4 text-center">
          <Lock className="mx-auto size-10 text-muted-foreground" />
          <h1 className="mt-3 text-xl font-bold">
            {lang === "mr" ? "प्रक्रियादार खात्यासाठी उपलब्ध नाही" : lang === "hi" ? "प्रोसेसर खाते के लिए उपलब्ध नहीं" : "Not available for processor accounts"}
          </h1>
          <p className="mt-2 text-sm text-muted-foreground">
            {lang === "mr"
              ? "स्मार्ट कृषी साधने शेतकरी, खरेदीदार व प्रशासकांसाठी आहेत."
              : lang === "hi"
              ? "स्मार्ट कृषि टूल किसानों, खरीदारों और एडमिन के लिए हैं।"
              : "Smart farming tools are for farmer, buyer and admin accounts."}
          </p>
