...
export const VoiceModal: React.FC<VoiceModalProps> = ({
  ...
  const friendlyMicError = (raw: string): string => {
    ...
    if (raw === 'not-supported') {
      return lang === 'mr'
        ? 'या ब्राउझरमध्ये आवाज ओळख उपलब्ध नाही (Chrome किंवा Edge वापरा). कृपया खाली टाइप करा.'
        : lang === 'hi'
        ? 'इस ब्राउज़र में आवाज़ पहचान उपलब्ध नहीं है (Chrome या Edge इस्तेमाल करें)। कृपया नीचे टाइप करें।'
        : 'Voice input needs Chrome or Edge — you can type your question below.';
    }
    if (raw === 'network') {
      return lang === 'mr'
        ? 'आवाज ओळखण्यासाठी इंटरनेट लागते. कनेक्शन तपासा किंवा टाइप करा.'
        : lang === 'hi'
        ...
        <div className="flex-1 overflow-y-auto px-5 pb-3 space-y-4">
          ...
          {thinking && (
            <div className="flex items-center gap-2 text-sm text-neutral-500">
              ...
              {lang === 'mr' ? 'विचार करत आहे...' : lang === 'hi' ? 'सोच रहा हूँ...' : 'Thinking...'}
            </div>
          )}

          {response && (
            <div className="flex items-start gap-2.5" translate="no">
              <span
              ...
              <div className="max-w-[85%] space-y-2.5">
                <p className="text-sm text-neutral-800 leading-relaxed" lang={lang}>
                  {streamedResponse}
