// All India states/UTs with their districts, for use in location dropdowns.
export interface StateDistricts {
  state: string;
  districts: string[];
}

export const INDIA_STATE_DISTRICTS: StateDistricts[] = [
  {
    state: "Andhra Pradesh",
    districts: [
      "Anantapur", "Chittoor", "East Godavari", "Guntur", "Krishna", "Kurnool",
      "Nellore", "Prakasam", "Srikakulam", "Visakhapatnam", "Vizianagaram",
      "West Godavari", "YSR Kadapa", "Anakapalli", "Annamayya", "Alluri Sitharama Raju",
  ...
  },
  {
    ...
    districts: [
      ...
      "Kamle", "Pakke Kessang", "Capital Complex Itanagar",
    ],
  },
  {
    state: "Assam",
...
export const INDIA_DISTRICT_OPTIONS: { state: string; district: string }[] =
  INDIA_STATE_DISTRICTS.flatMap((s) => s.districts.map((d) => ({ state: s.state, district: d })));
