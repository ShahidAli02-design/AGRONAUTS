...
export class ApiService {
  ...
  static async gradeQuality(batchId: string, image: string, crop: string, quantity: number, localMetrics?: LocalProduceMetrics | null): Promise<{
    success: boolean;
    batchId: string;
    ...
    return this.request('/ai/quality-grade', {
      method: 'POST',
      body: JSON.stringify({ batchId, image, crop, quantity, localMetrics })
    });
  }
